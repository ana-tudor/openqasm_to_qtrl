...
examples/complex_resonator_model.ipynb
examples/confidence_interval.py
examples/confidence_interval2.py
...
examples/doc_model_twocomponents.py
...
examples/example_emcee_with_Model.py
...
examples/fit_multi_datasets.py
examples/fit_with_algebraic_constraint.py
examples/fit_with_analytic_jacobian.py
examples/fit_with_bounds.py
examples/fit_with_inequality.py
examples/lmfit-model.ipynb
examples/lmfit_and_emcee.py
examples/lmfit_brute_example.ipynb
examples/lmfit_emcee_example.ipynb
examples/lmfit_emcee_model_selection.ipynb
examples/model1d_gauss.dat
examples/plot_fit.py
examples/plot_fit2.py
examples/sinedata.dat
examples/test_peak.dat
examples/use_pandas.py
examples/.ipynb_checkpoints/Untitled-checkpoint.ipynb
examples/.ipynb_checkpoints/Untitled1-checkpoint.ipynb
examples/.ipynb_checkpoints/lmfit_brute_example-checkpoint.ipynb
lmfit/__init__.py
lmfit/_ampgo.py
lmfit/_version.py
lmfit/confidence.py
