...
class SD_Module(SD_Object):
    ...
    def readRegisterByNumber(self, varNumber):
        ...
        if self._SD_Object__handle > 0:
            error = c_int32()
            varValue = self._SD_Object__core_dll.SD_Module_readRegister(self._SD_Object__handle, varNumber,
                                                                        byref(error))
            error = error.value
        else:
    ...
    def readRegisterDoubleByNumber(self, varNumber, unit):
        ...
        if self._SD_Object__handle > 0:
            ...
            varValue = self._SD_Object__core_dll.SD_Module_readDoubleRegister(self._SD_Object__handle, varNumber,
    ...
    def writeRegisterByName(self, varName, varValue):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_Module_writeRegisterWithName(self._SD_Object__handle, varName.encode(),
                                                                             varValue)
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def writeRegisterDoubleByNumber(self, varNumber, value, unit):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_Module_writeDoubleRegister(self._SD_Object__handle, varNumber,
    ...
    def DAQread(self, nDAQ, nPoints, timeOut=0):
        if self._SD_Object__handle > 0:
            if nPoints > 0:
                ...
                nPoints = self._SD_Object__core_dll.SD_DIO_DAQread(self._SD_Object__handle, nDAQ, data, nPoints,
                                                                   timeOut)
    ...
    def DAQread(self, nDAQ, nPoints, timeOut=0):
        if self._SD_Object__handle > 0:
            if nPoints > 0:
                ...
                nPoints = self._SD_Object__core_dll.SD_AIN_DAQread(self._SD_Object__handle, nDAQ, data, nPoints,
                                                                   timeOut)
