...
##### 11/28/2016 (Leigh Martin) Adding additional functions that are missing #####
##### 2/22/2017 (Dar Dahlen) included getStatus                              #####
    ...
    def createStreamFile(self, filePath):
        ...
        ats.AlazarCreateStreamFileA(self.handle, filePath) # Python uses ASCII string coding by default. Hence the 'A'
    ...
    def waitNextAsyncBufferComplete(self, buffer, bytesToCopy, timeout_ms):
        """Returns when the next buffer is filled. Use this with the ADMA_ALLOC_BUFFERS flag, which
        automatically allocates buffers"""
        ats.AlazarWaitNextAsyncBufferComplete(self.handle, buffer, bytesToCopy, timeout_ms)
